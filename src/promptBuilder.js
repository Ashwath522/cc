...
/**
 * CANONICAL 5-PART PRODUCT CONTENT STRUCTURE:
 * 1. MOOD LINE — short, no product name/material yet.
 * 2. INTRO — names product type + single distinctive design feature.
 * 3. STORY — 2-3 sentences on construction/material/secondary detail.
 * 4. CLOSE — names the product BY NAME exactly once, circles back to mood/use-case.
 * 5. BULLETS — deterministic, generated from attributes only, never by the LLM. Only include bullets for attributes actually present.
 *
 * Clarification on mood vocabulary:
 * Illustrative mood registers (calm, elegant, sophisticated, inviting, etc.) are EXAMPLES of tone, never literal vocabulary to reuse — the banned-word list and opening/close strategy rotation elsewhere in this template exist specifically to prevent any one of these becoming a repeated default. Do not treat this list as approved vocabulary.
 */
